package webapi.infrastructure.factory;
...
public final class ResponseFactory {
    ...
    public static <T> ResponseEntity<BaseResponse> error(HttpStatus httpStatus, String message, T data) {
        BaseResponse response = BaseResponse.builder()
                .success(false)
                .message(message)
                .data(data).build();
    ...
    public static <I> ResponseEntity<BaseResponse<I>> response(I data, boolean isSuccess, String message) {
